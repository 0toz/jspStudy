...
public class Ex02 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 서블릿 : java코드에 HTML, CSS , JavaScript 를 섞어서 사용(
		// JSP : HTML, CSS, JavaScript 에 자바코드를 섞어서 사용.
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<h1 style=\'font-size: 60px; background-color: yellow;\'> 제목태그</h1>");
		...
		out.println("<span>javarststes</span>");
		out.println("</body>");
		out.println("</html>");                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
